...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument('--cfg', type=str, default='/mnt/bn/experience0313/gengwenjia/timeblip/configs/train_qvhighlights.yml', help='config file')
        ...
        '''update parser by yml'''
        if args.cfg:
            import_cfg(args.cfg, vars(args))
