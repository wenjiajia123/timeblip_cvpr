...
from lavis.models.blip2_models.blip2_image_text_matching import fixscore
...
def eval_epoch_post_processing(submission, opt, gt_data, save_submission_filename):
    ...
    if opt.nms_thd != -1:
        ...
        if opt.eval_split_name == "val":
            print("Evaluating nms results")
            print(submission_after_nms)
            print("gt data")
            print(gt_data)
...
def compute_mr_results(model, eval_loader, opt, epoch_i=None, criterion=None, tb_writer=None):
    ...
    for batch in tqdm(eval_loader, desc="compute st ed scores"):
        ...
        outputs = fixscore(outputs, targets)
        ...
        if opt.span_loss_type == "l1":
            ...
            saliency_scores = []
            valid_vid_lengths = [75.0, 75.0, 75.0, 75.0]
